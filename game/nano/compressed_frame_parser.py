...
# Set up serial connection (adjust port and baud rate)
SERIAL_PORT = (
    "/dev/tty.usbmodem3C8427C2DF902"  # Change this to your actual port if needed
)
# BAUD_RATE = 115200
BAUD_RATE = 9600
...
class Game:
    ...
    def draw_to_screen(self):
        # If the game is over, display a black screen
        if self.game_over:
...
while True:
    # Reset game state when "Game Started!" is received
    if game.game_started:
        game.game_started = False  # Reset game_started flag after starting the game
        game.game_over = False
        print("Game Started! Press Enter to play.")
...
# # Set up serial connection (adjust port and baud rate)
# SERIAL_PORT = "/dev/tty.usbmodem3C8427C2DF902"  # Change this to your actual port if needed
# BAUD_RATE = 115200
# # BAUD_RATE = 9600
